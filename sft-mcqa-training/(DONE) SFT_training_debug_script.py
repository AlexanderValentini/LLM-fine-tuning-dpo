...
train_data_path = os.path.join(project_dir, 'datasets/sft/sft_train_dataset.jsonl')
vali_data_path = os.path.join(project_dir, 'datasets/sft/sft_validation_dataset.jsonl')
